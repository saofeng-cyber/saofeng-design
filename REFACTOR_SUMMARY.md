...
本次重构从 Button 和 Alert 组件中抽取了共同的样式和功能，创建了一个基础公共组件：`BaseInteractive`。这个基础组件提供了统一的交互行为，提高了代码复用性和维护性。

## 抽取的公共组件

### BaseInteractive 基础交互组件
...
1. **抽取了一个高质量的基础组件 BaseInteractive**，为后续组件开发奠定了基础
