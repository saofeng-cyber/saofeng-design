...
// tsconfig.json
{
  ...
  "include": [
    "src/**/*",
    "node_modules/@saofeng-design/*/types/*.d.ts"
  ]
}
```
...
<head>
  <!-- 引入样式 -->
  <link rel="stylesheet" href="https://unpkg.com/@saofeng-design/theme/dist/index.css">
</head>
<body>
  <div id="app">
...
<template>
  <div class="test-page">
    ...
    <div class="test-section">
      <h2>按钮测试</h2>
      <SButton type="primary" @click="showMessage">
        点击测试
      </SButton>
    </div>
...
如果您遇到其他问题，可以：
- 查看 [常见问题](/guide/faq)
- 在 [GitHub Issues](https://github.com/saofeng-design/saofeng-design/issues) 提问
- 参考 [示例项目](https://github.com/saofeng-design/examples)
:::
